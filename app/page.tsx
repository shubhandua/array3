      ...
      <div className="relative z-10">
        ...
        <main className="container mx-auto px-4 py-12 pt-20">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {['AI & Machine Learning', 'Enterprise SaaS', 'Cybersecurity', 'Data Infrastructure', 'DevOps', 'FinTech'].map((area, index) => (
                <motion.div
                  key={area}
          ...
          <section className="text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-8">Ready to Transform Your Idea?</h2>
            <Link href="/contact" className="bg-white text-black px-6 py-3 rounded-md hover:bg-gray-200 transition-colors inline-flex items-center justify-center">
              Apply for Funding
              <ArrowRight className="ml-2 w-4 h-4" />
            </Link>
          </section>
        ...
        <footer className="border-t border-gray-800 py-8 mt-20">
          <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">&copy; {new Date().getFullYear()} Array Venture. All rights reserved.</div>
